...
print(tablecells[1].text, tablecells[3].text, tablecells[5].text, tablecells[6].text)

tablerows = soup.findAll("div", attrs={"class":"table-row table-row-hover"})
counter = 1
...
for x in range(5):
    ...
    print(f"high:{high}")
    print(f"low:{low}")
    print(f'Calculated change%:{"${:,.2f}".format(calc_change)}')
    print()
    print()
